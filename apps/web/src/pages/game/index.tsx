			...
			<Center w={"100vw"} pt={50}>
				<Paper w={900} shadow="lg" withBorder>
					<div style={{ display: "flex", justifyContent: "space-between" }}>
						<div style={{ width: "70%" }}>
							{game.isConnected && (
								<Chessboard submitMove={game.makeMove} />
							)}
						</div>
						<div style={{ width: "28%", padding: "20px" }}>
							<Timer username={""} isPlayersTurn={false} timeLeftAtLastUpdate={100} />
							<Timer username={""} isPlayersTurn={true} timeLeftAtLastUpdate={100} />
